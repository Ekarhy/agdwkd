...
<tr>
 ...
 <td>
    <a href="ubah_member.php?id_member=<?=$data_member['id']?>" class="btn btn-success">Ubah</a> |
    <a href="hapus.php?id=<?=$data_member['id']?>" name="id" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
